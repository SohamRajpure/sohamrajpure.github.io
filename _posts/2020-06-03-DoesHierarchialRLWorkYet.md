...
<figure>
    ...
    <figcaption>The goal conditioned hierarchial framework shared by HAC and RPL.  The superscripts on the policies stand for higher and lower level. Image from the RPL Paper.</figcaption>
</figure>
